data segment
    PROG1 db "Tache 1 en cours d'execution...",10,13,"$"
    PROG2 db "Tache 2 en cours d'execution...",10,13,"$"
    PROG3 db "Tache 3 en cours d'execution...",10,13,"$"
    PROG4 db "Tache 4 en cours d'execution...",10,13,"$"
    PROG5 db "Tache 5 en cours d'execution...",10,13,"$"
    NEWLINE db 10,13,"$"          ; Cha?ne pour un saut de ligne
    INSTALLED db "Deroutement fait",10,13,"$"
    timer_counter dw 0            ; Compteur de temps pour compter 5 secondes
    current_task db 0             ; Indicateur de la t?che actuelle
    total_counter dw 0            ; Compteur total pour arr?ter apr?s 5 minutes
data ends
...
code segment
    ...
    deroute proc near
        ...
        ; V?rifie si 5 minutes se sont ?coul?es
